...
public class ModelManager {
    ...
    public boolean update(Model model) {
        if(this.getById(model.getId()) == null) {
            Helper.showMessage("Record not found with ID: "+ model.getId());
            return false;
        }
    ...
    public boolean delete(int id) {
        if(this.getById(id) == null) {
            Helper.showMessage("Record not found with ID: "+ id);
            return false;
        }
    ...
    public ArrayList<Model> filterForTable(int brandId, Model.Fuel fuel, Model.Gear gear, Model.Type type) {
